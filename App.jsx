...
// Mock Origin (Iligan City Center)
export const MOCK_ILIGAN_CENTER = { lat: 8.2280, lng: 124.2452 };

// --- MOCK DATA (FOOD & RESTAURANTS) ---
// Mock data (MOCK_FOOD_ITEMS, MOCK_CATEGORIES, etc.) has been removed.
// We now fetch all data directly from Supabase.

// Mock Order Status Stages (This is an app-level constant)
